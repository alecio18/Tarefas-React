...
import LivrosLista from './livrosLista'
...
export default class Livros extends Component {
    ...
    concluidosTotal(){        
         ...
         Object.entries(this.state.lista).forEach(([, valor]) => {
             if(valor.completo === true && valor.tipo === 'livro'){
                 contConcluidas += 1
             }
             if(valor.tipo === 'livro'){
                 contTotal += 1
    ...
    render() {
        return ( 
                <div>                           
                    ...
                    <PageHeader nome='Livros' small ='Cadastro' total={this.concluidosTotal()}/>
                    
                    <div className='col-xs-12'>
                    <br />
                        <LivrosForm descricao = {this.state.descricao}
                    ...
                    <LivrosLista lista = { this.listaNaoConcluida() }
